...
function Dashboard() {
  ...
  return (
    <div className="grid min-h-screen w-full overflow-hidden lg:grid-cols-[280px_1fr]" data-theme={theme}>
      <div className="hidden bg-base-100/40 lg:block " data-theme={theme}>
          ...
          <div className="flex-1">
            <nav className="grid items-start px-4 text-sm font-medium">
              <NavLink to="/dashboard" className={({ isActive }) =>
                `flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${isActive ? 'dark:hover:bg-gray-600 hover:bg-gray-300 dark:bg-gray-600 bg-gray-300 text-gray-900 dark:text-gray-50' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-50 dark:hover:bg-gray-500 '}`}>
      ...
      <div className="flex flex-col sticky">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 bg-base-100/40 px-6  sticky top-0 shadow-lg" data-theme={theme}>
          <div className="flex-1">
